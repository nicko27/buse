<?php
     ...
     * VERSION CORRIGÉE avec usort au lieu de array_sort
     */
    ...
    try {
        ...
        foreach ($allStats as $stepName => $stepStats) {
            ...
            if (isset($stepStats['error']) && $stepStats['error']) {
                ...
                $criticalSteps = ['config', 'database', 'logger', 'router', 'routing', 'access', 'twig_base'];
        ...
        if (isset($logger) && $logger) {
            ...
            if ($finalStats['total_init_time'] > 1000) {
                // Plus d'1 seconde
                // ✅ CORRECTION : Utiliser usort au lieu de array_sort
