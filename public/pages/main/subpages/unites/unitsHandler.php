...
function getChildrenUnits($dateOperation, $schema, $parentCu, $cuCie = 0, $cuCob = 0, $cobCity = "")
{
    ...
    $attributes           = ["cn", "l", "businessCategory", "departmentUID", "parentDepartmentUID", "codeServiceRio", "ou", "telephoneNumber", "postalAddress", "codeUnite", "rank"];
